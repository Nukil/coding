...
public class FaceFeatureVerify {
	...
	private static final IgniteCache<String, String> cache = Ignition.ignite("Netposa").cache("Netposa_LIBRARY_GLOBAL");
	private static final String version = cache.get("VERSION");
