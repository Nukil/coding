...
public class AccompanyAyalyzeResult implements org.apache.thrift.TBase<AccompanyAyalyzeResult, AccompanyAyalyzeResult._Fields>, java.io.Serializable, Cloneable, Comparable<AccompanyAyalyzeResult> {
  ...
  public java.util.List<java.lang.String> logNums; // required
  ...
  public AccompanyAyalyzeResult(
    java.util.List<java.lang.String> logNums,
    int accompanyCount)
  {
    this();
  ...
  public AccompanyAyalyzeResult(AccompanyAyalyzeResult other) {
    ...
    if (other.isSetLogNums()) {
      java.util.List<java.lang.String> __this__logNums = new java.util.ArrayList<java.lang.String>(other.logNums);
  ...
  public java.util.Iterator<java.lang.String> getLogNumsIterator() {
    return (this.logNums == null) ? null : this.logNums.iterator();
  }

  public void addToLogNums(java.lang.String elem) {
    if (this.logNums == null) {
      this.logNums = new java.util.ArrayList<java.lang.String>();
    }
    this.logNums.add(elem);
  }

  public java.util.List<java.lang.String> getLogNums() {
    return this.logNums;
  }

  public AccompanyAyalyzeResult setLogNums(java.util.List<java.lang.String> logNums) {
    this.logNums = logNums;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case LOG_NUMS:
      if (value == null) {
        ...
        setLogNums((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("AccompanyAyalyzeResult(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.logNums = new java.util.ArrayList<java.lang.String>(_list32.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AccompanyAyalyzeResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.logNums != null) {
        oprot.writeFieldBegin(LOG_NUMS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter35 : struct.logNums)
          {
      ...
      if (struct.isSetLogNums()) {
        {
          ...
          for (java.lang.String _iter36 : struct.logNums)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.logNums = new java.util.ArrayList<java.lang.String>(_list37.size);
