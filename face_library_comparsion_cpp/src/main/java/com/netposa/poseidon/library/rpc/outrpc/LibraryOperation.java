...
public class LibraryOperation implements org.apache.thrift.TBase<LibraryOperation, LibraryOperation._Fields>, java.io.Serializable, Cloneable, Comparable<LibraryOperation> {
  ...
  public String libraryId; // required
  ...
  public LibraryOperation setLibraryId(String libraryId) {
    this.libraryId = libraryId;
    return this;
  }
  ...
  public int compareTo(LibraryOperation other) {
    ...
    lastComparison = Boolean.valueOf(isSetLibraryId()).compareTo(other.isSetLibraryId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLibraryId()) {
    ...
    lastComparison = Boolean.valueOf(isSetLibraryType()).compareTo(other.isSetLibraryType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLibraryType()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LibraryOperation(");
    boolean first = true;
