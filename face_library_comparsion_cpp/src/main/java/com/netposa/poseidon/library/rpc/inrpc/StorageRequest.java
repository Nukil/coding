        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.storageInfos = new java.util.ArrayList<StorageInfo>(_list16.size);
                StorageInfo _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new StorageInfo();
                  _elem17.read(iprot);
                  struct.storageInfos.add(_elem17);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.netposa.poseidon.library.rpc.inrpc.OperationType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StorageRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.storageInfos != null) {
        oprot.writeFieldBegin(STORAGE_INFOS_FIELD_DESC);
        {
          ...
          for (StorageInfo _iter19 : struct.storageInfos)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetStorageInfos()) {
        {
          ...
          for (StorageInfo _iter20 : struct.storageInfos)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.storageInfos = new java.util.ArrayList<StorageInfo>(_list21.size);
          StorageInfo _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new StorageInfo();
            _elem22.read(iprot);
            struct.storageInfos.add(_elem22);
          }
        }
        struct.setStorageInfosIsSet(true);
      }
