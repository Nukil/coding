            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.imgInfos = new java.util.ArrayList<ImgInfo>(_list8.size);
                ImgInfo _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new ImgInfo();
                  _elem9.read(iprot);
                  struct.imgInfos.add(_elem9);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StorageInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.imgInfos != null) {
        oprot.writeFieldBegin(IMG_INFOS_FIELD_DESC);
        {
          ...
          for (ImgInfo _iter11 : struct.imgInfos)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetImgInfos()) {
        {
          ...
          for (ImgInfo _iter12 : struct.imgInfos)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.imgInfos = new java.util.ArrayList<ImgInfo>(_list13.size);
          ImgInfo _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new ImgInfo();
            _elem14.read(iprot);
            struct.imgInfos.add(_elem14);
          }
        }
        struct.setImgInfosIsSet(true);
      }
