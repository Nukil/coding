...
public class StorageInfo implements org.apache.thrift.TBase<StorageInfo, StorageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<StorageInfo> {
  ...
  public StorageInfo setLibraryId(String libraryId) {
    this.libraryId = libraryId;
    return this;
  }
  ...
  public StorageInfo setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public StorageInfo setExt(String ext) {
    this.ext = ext;
    return this;
  }
  ...
  public int compareTo(StorageInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetImgInfos()).compareTo(other.isSetImgInfos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetImgInfos()) {
