...
public class ImgScore implements org.apache.thrift.TBase<ImgScore, ImgScore._Fields>, java.io.Serializable, Cloneable, Comparable<ImgScore> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ImgScore");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ImgScoreStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ImgScoreTupleSchemeFactory();

  public String imgId; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ImgScore.class, metaDataMap);
  }
   ...
   */
  public ImgScore(ImgScore other) {
  ...
  public ImgScore deepCopy() {
    return new ImgScore(this);
  }
  ...
  public ImgScore setImgId(String imgId) {
    this.imgId = imgId;
    return this;
  }
  ...
  public ImgScore setScore(double score) {
    this.score = score;
    setScoreIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ImgScore)
      return this.equals((ImgScore)that);
    return false;
  }

  public boolean equals(ImgScore that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(ImgScore other) {
    ...
    lastComparison = Boolean.valueOf(isSetImgId()).compareTo(other.isSetImgId());
    if (lastComparison != 0) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ImgScore(");
    boolean first = true;
  ...
  private static class ImgScoreStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ImgScoreStandardScheme getScheme() {
      return new ImgScoreStandardScheme();
    }
  }

  private static class ImgScoreStandardScheme extends org.apache.thrift.scheme.StandardScheme<ImgScore> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ImgScore struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ImgScore struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ImgScoreTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ImgScoreTupleScheme getScheme() {
      return new ImgScoreTupleScheme();
    }
  }

  private static class ImgScoreTupleScheme extends org.apache.thrift.scheme.TupleScheme<ImgScore> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ImgScore struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ImgScore struct) throws org.apache.thrift.TException {
