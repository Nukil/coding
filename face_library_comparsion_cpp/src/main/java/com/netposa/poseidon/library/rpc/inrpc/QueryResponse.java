...
public class QueryResponse implements org.apache.thrift.TBase<QueryResponse, QueryResponse._Fields>, java.io.Serializable, Cloneable, Comparable<QueryResponse> {
  ...
  public QueryResponse setMessage(java.lang.String message) {
    this.message = message;
    return this;
  }
  ...
  public int compareTo(QueryResponse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRecordInfos()).compareTo(other.isSetRecordInfos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecordInfos()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("QueryResponse(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.recordInfos = new java.util.ArrayList<RecordInfo>(_list48.size);
                RecordInfo _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new RecordInfo();
                  _elem49.read(iprot);
                  struct.recordInfos.add(_elem49);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.recordInfos != null) {
        oprot.writeFieldBegin(RECORD_INFOS_FIELD_DESC);
        {
          ...
          for (RecordInfo _iter51 : struct.recordInfos)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetRecordInfos()) {
        {
          ...
          for (RecordInfo _iter52 : struct.recordInfos)
          {
            _iter52.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.recordInfos = new java.util.ArrayList<RecordInfo>(_list53.size);
          RecordInfo _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = new RecordInfo();
            _elem54.read(iprot);
            struct.recordInfos.add(_elem54);
          }
        }
        struct.setRecordInfosIsSet(true);
      }
