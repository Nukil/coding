...
public class RecordInfo implements org.apache.thrift.TBase<RecordInfo, RecordInfo._Fields>, java.io.Serializable, Cloneable, Comparable<RecordInfo> {
  ...
  public String highestScoreImgId; // required
  ...
  public RecordInfo setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public RecordInfo setExt(String ext) {
    this.ext = ext;
    return this;
  }
  ...
  public String getHighestScoreImgId() {
    return this.highestScoreImgId;
  }

  public RecordInfo setHighestScoreImgId(String highestScoreImgId) {
    this.highestScoreImgId = highestScoreImgId;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case HIGHEST_SCORE_IMG_ID:
      if (value == null) {
        ...
        setHighestScoreImgId((String)value);
      }
      break;
  ...
  public int compareTo(RecordInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetImgScore()).compareTo(other.isSetImgScore());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetImgScore()) {
    ...
    lastComparison = Boolean.valueOf(isSetHighestScore()).compareTo(other.isSetHighestScore());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetHighestScoreImgId()).compareTo(other.isSetHighestScoreImgId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHighestScoreImgId()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RecordInfo(");
    boolean first = true;
