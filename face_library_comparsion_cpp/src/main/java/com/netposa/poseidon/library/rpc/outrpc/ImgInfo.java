...
public class ImgInfo implements org.apache.thrift.TBase<ImgInfo, ImgInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ImgInfo> {
  ...
  public ImgInfo setImgId(String imgId) {
    this.imgId = imgId;
    return this;
  }
  ...
  public ImgInfo setFeature(byte[] feature) {
    this.feature = feature == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(feature.clone());
    return this;
  }

  public ImgInfo setFeature(java.nio.ByteBuffer feature) {
    this.feature = org.apache.thrift.TBaseHelper.copyBinary(feature);
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ImgInfo(");
    boolean first = true;
