...
public class QueryRequest implements org.apache.thrift.TBase<QueryRequest, QueryRequest._Fields>, java.io.Serializable, Cloneable, Comparable<QueryRequest> {
  ...
  public java.util.List<java.lang.String> libraryIds; // required
  ...
  public QueryRequest(
    java.util.List<java.lang.String> libraryIds,
    short similarity,
    int rCount,
  ...
  public QueryRequest(QueryRequest other) {
    ...
    if (other.isSetLibraryIds()) {
      java.util.List<java.lang.String> __this__libraryIds = new java.util.ArrayList<java.lang.String>(other.libraryIds);
  ...
  public java.util.Iterator<java.lang.String> getLibraryIdsIterator() {
    return (this.libraryIds == null) ? null : this.libraryIds.iterator();
  }

  public void addToLibraryIds(java.lang.String elem) {
    if (this.libraryIds == null) {
      this.libraryIds = new java.util.ArrayList<java.lang.String>();
    }
    this.libraryIds.add(elem);
  }

  public java.util.List<java.lang.String> getLibraryIds() {
    return this.libraryIds;
  }

  public QueryRequest setLibraryIds(java.util.List<java.lang.String> libraryIds) {
    this.libraryIds = libraryIds;
    return this;
  }
  ...
  public QueryRequest setFeature(java.util.List<java.lang.Double> feature) {
    this.feature = feature;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case LIBRARY_IDS:
      if (value == null) {
        ...
        setLibraryIds((java.util.List<java.lang.String>)value);
      }
      break;
    ...
    case SIMILARITY:
      if (value == null) {
        ...
        setSimilarity((java.lang.Short)value);
      }
      break;
    ...
    case R_COUNT:
      if (value == null) {
        ...
        setRCount((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(QueryRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLibraryIds()).compareTo(other.isSetLibraryIds());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSimilarity()).compareTo(other.isSetSimilarity());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSimilarity()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRCount()).compareTo(other.isSetRCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRCount()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("QueryRequest(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.libraryIds = new java.util.ArrayList<java.lang.String>(_list24.size);
                java.lang.String _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = iprot.readString();
                  struct.libraryIds.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.feature = new java.util.ArrayList<java.lang.Double>(_list27.size);
                double _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = iprot.readDouble();
                  struct.feature.add(_elem28);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.libraryIds != null) {
        oprot.writeFieldBegin(LIBRARY_IDS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter30 : struct.libraryIds)
          {
      ...
      if (struct.feature != null) {
        oprot.writeFieldBegin(FEATURE_FIELD_DESC);
        {
          ...
          for (double _iter31 : struct.feature)
          {
      ...
      if (struct.isSetLibraryIds()) {
        {
          ...
          for (java.lang.String _iter32 : struct.libraryIds)
          {
      ...
      if (struct.isSetFeature()) {
        {
          ...
          for (double _iter33 : struct.feature)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.libraryIds = new java.util.ArrayList<java.lang.String>(_list34.size);
          java.lang.String _elem35;
          for (int _i36 = 0; _i36 < _list34.size; ++_i36)
          {
            _elem35 = iprot.readString();
            struct.libraryIds.add(_elem35);
          }
        }
        struct.setLibraryIdsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.feature = new java.util.ArrayList<java.lang.Double>(_list37.size);
          double _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = iprot.readDouble();
            struct.feature.add(_elem38);
          }
        }
        struct.setFeatureIsSet(true);
      }
