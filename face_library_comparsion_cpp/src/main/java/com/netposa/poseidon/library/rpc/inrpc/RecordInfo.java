            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.imgScore = new java.util.ArrayList<ImgScore>(_list40.size);
                ImgScore _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new ImgScore();
                  _elem41.read(iprot);
                  struct.imgScore.add(_elem41);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RecordInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.imgScore != null) {
        oprot.writeFieldBegin(IMG_SCORE_FIELD_DESC);
        {
          ...
          for (ImgScore _iter43 : struct.imgScore)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetImgScore()) {
        {
          ...
          for (ImgScore _iter44 : struct.imgScore)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.imgScore = new java.util.ArrayList<ImgScore>(_list45.size);
          ImgScore _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new ImgScore();
            _elem46.read(iprot);
            struct.imgScore.add(_elem46);
          }
        }
        struct.setImgScoreIsSet(true);
      }
