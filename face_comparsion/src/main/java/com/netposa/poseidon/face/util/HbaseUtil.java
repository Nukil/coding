...
public class HbaseUtil {
    ...
    public static void init() {
        ...
        hConfiguration.set("mapreduce.task.timeout", "3600000");
        hConfiguration.set("hbase.client.scanner.timeout.period", "3600000");
        hConfiguration.set("hbase.rpc.timeout", "3600000");
    }
...
//     * @return
//     */
//    public static Connection getConn(String zkConn) {
//        try {
//            hConfiguration.set("hbase.zookeeper.quorum",zkConn);
//            if (hConnection == null || hConnection.isClosed()) {
//                hConnection = ConnectionFactory.createConnection(hConfiguration);
//            }
//        } catch (IOException e) {
...
//    }
    ...
    public static List<Result> getRows(String tableName, String startRow, String stopRow) {
        ...
        try {
            ...
            log.info(String.format("scan data send to list startRow[%s], endRow[%s]", startRow, stopRow));
            list = new ArrayList<Result>();
