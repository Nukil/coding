...
public class SearchFeatureByLogResponse implements org.apache.thrift.TBase<SearchFeatureByLogResponse, SearchFeatureByLogResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SearchFeatureByLogResponse> {
  ...
  public SearchFeatureByLogResponse setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SearchFeatureByLogResponse(");
    boolean first = true;
        ...
        switch (schemeField.id) {
          case 1: // R_CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.rCode = com.netposa.poseidon.face.rpc.StatusCode.findByValue(iprot.readI32());
