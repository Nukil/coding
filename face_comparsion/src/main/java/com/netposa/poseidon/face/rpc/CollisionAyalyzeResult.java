...
public class CollisionAyalyzeResult implements org.apache.thrift.TBase<CollisionAyalyzeResult, CollisionAyalyzeResult._Fields>, java.io.Serializable, Cloneable, Comparable<CollisionAyalyzeResult> {
  ...
  public java.util.List<java.util.List<String>> logNums; // required
  ...
  public CollisionAyalyzeResult(
    java.util.List<java.util.List<String>> logNums,
    int regionCount)
  {
    this();
  ...
  public CollisionAyalyzeResult(CollisionAyalyzeResult other) {
    ...
    if (other.isSetLogNums()) {
      java.util.List<java.util.List<String>> __this__logNums = new java.util.ArrayList<java.util.List<String>>(other.logNums.size());
      for (java.util.List<String> other_element : other.logNums) {
        java.util.List<String> __this__logNums_copy = new java.util.ArrayList<String>(other_element);
  ...
  public java.util.Iterator<java.util.List<String>> getLogNumsIterator() {
    return (this.logNums == null) ? null : this.logNums.iterator();
  }

  public void addToLogNums(java.util.List<String> elem) {
    if (this.logNums == null) {
      this.logNums = new java.util.ArrayList<java.util.List<String>>();
    }
    this.logNums.add(elem);
  }

  public java.util.List<java.util.List<String>> getLogNums() {
    return this.logNums;
  }

  public CollisionAyalyzeResult setLogNums(java.util.List<java.util.List<String>> logNums) {
    this.logNums = logNums;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LOG_NUMS:
      if (value == null) {
        ...
        setLogNums((java.util.List<java.util.List<String>>)value);
      }
      break;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CollisionAyalyzeResult(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.logNums = new java.util.ArrayList<java.util.List<String>>(_list16.size);
                java.util.List<String> _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  {
                    org.apache.thrift.protocol.TList _list19 = iprot.readListBegin();
                    _elem17 = new java.util.ArrayList<String>(_list19.size);
                    String _elem20;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CollisionAyalyzeResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.logNums != null) {
        oprot.writeFieldBegin(LOG_NUMS_FIELD_DESC);
        {
          ...
          for (java.util.List<String> _iter22 : struct.logNums)
          {
            {
      ...
      if (struct.isSetLogNums()) {
        {
          ...
          for (java.util.List<String> _iter24 : struct.logNums)
          {
            {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.logNums = new java.util.ArrayList<java.util.List<String>>(_list26.size);
          java.util.List<String> _elem27;
          for (int _i28 = 0; _i28 < _list26.size; ++_i28)
          {
            {
              org.apache.thrift.protocol.TList _list29 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
              _elem27 = new java.util.ArrayList<String>(_list29.size);
              String _elem30;
