...
public class FaceTrackingResult implements org.apache.thrift.TBase<FaceTrackingResult, FaceTrackingResult._Fields>, java.io.Serializable, Cloneable, Comparable<FaceTrackingResult> {
  ...
  public FaceTrackingResult setCameraId(String cameraId) {
    this.cameraId = cameraId;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case OCCURRENCES_COUNT:
      if (value == null) {
        ...
        setOccurrencesCount((Integer)value);
      }
      break;
  ...
  public int compareTo(FaceTrackingResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetFaceImgs()).compareTo(other.isSetFaceImgs());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetOccurrencesCount()).compareTo(other.isSetOccurrencesCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FaceTrackingResult(");
    boolean first = true;
