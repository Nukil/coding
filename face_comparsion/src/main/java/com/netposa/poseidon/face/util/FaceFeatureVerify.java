...
public class FaceFeatureVerify {
    private static final IgniteCache<String, Properties> CACHE = Ignition.ignite("Netposa").cache("Netposa_FACE_GLOBAL");
	private static final String VERSION = CACHE.get("SERVER").getProperty("face.arithmetic.version");
	...
	public static float verify(byte[] pFaceFeat1, int offset1,
		...
		if (VERSION.equals("20170601") || VERSION.equals("1.3")) {
			return ftScore;
		} else {
