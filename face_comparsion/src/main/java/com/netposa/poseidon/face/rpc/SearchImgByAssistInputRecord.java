...
public class SearchImgByAssistInputRecord implements org.apache.thrift.TBase<SearchImgByAssistInputRecord, SearchImgByAssistInputRecord._Fields>, java.io.Serializable, Cloneable, Comparable<SearchImgByAssistInputRecord> {
  ...
  public SearchImgByAssistInputRecord setCameraID(String cameraID) {
    this.cameraID = cameraID;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ASSIST_DISTANCE:
      if (value == null) {
        ...
        setAssistDistance((Integer)value);
      }
      break;
    ...
    case EXCLUDE_DISTANCE:
      if (value == null) {
        ...
        setExcludeDistance((Integer)value);
      }
      break;
  ...
  public int compareTo(SearchImgByAssistInputRecord other) {
    ...
    lastComparison = Boolean.valueOf(isSetAssist()).compareTo(other.isSetAssist());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAssist()) {
    ...
    lastComparison = Boolean.valueOf(isSetAssistDistance()).compareTo(other.isSetAssistDistance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetExcludeDistance()).compareTo(other.isSetExcludeDistance());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SearchImgByAssistInputRecord(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new java.util.ArrayList<SearchImgResult>(_list48.size);
                SearchImgResult _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new SearchImgResult();
                  _elem49.read(iprot);
                  struct.resultList.add(_elem49);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.assist = new java.util.ArrayList<java.nio.ByteBuffer>(_list51.size);
                java.nio.ByteBuffer _elem52;
                for (int _i53 = 0; _i53 < _list51.size; ++_i53)
                {
                  _elem52 = iprot.readBinary();
                  struct.assist.add(_elem52);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.exclude = new java.util.ArrayList<java.nio.ByteBuffer>(_list54.size);
                java.nio.ByteBuffer _elem55;
                for (int _i56 = 0; _i56 < _list54.size; ++_i56)
                {
                  _elem55 = iprot.readBinary();
                  struct.exclude.add(_elem55);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SearchImgByAssistInputRecord struct) throws org.apache.thrift.TException {
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (SearchImgResult _iter57 : struct.resultList)
          {
            _iter57.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.assist != null) {
        oprot.writeFieldBegin(ASSIST_FIELD_DESC);
        {
          ...
          for (java.nio.ByteBuffer _iter58 : struct.assist)
          {
      ...
      if (struct.exclude != null) {
        oprot.writeFieldBegin(EXCLUDE_FIELD_DESC);
        {
          ...
          for (java.nio.ByteBuffer _iter59 : struct.exclude)
          {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (SearchImgResult _iter60 : struct.resultList)
          {
            _iter60.write(oprot);
          }
        }
      ...
      if (struct.isSetAssist()) {
        {
          ...
          for (java.nio.ByteBuffer _iter61 : struct.assist)
          {
      ...
      if (struct.isSetExclude()) {
        {
          ...
          for (java.nio.ByteBuffer _iter62 : struct.exclude)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.resultList = new java.util.ArrayList<SearchImgResult>(_list63.size);
          SearchImgResult _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new SearchImgResult();
            _elem64.read(iprot);
            struct.resultList.add(_elem64);
          }
        }
        struct.setResultListIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.assist = new java.util.ArrayList<java.nio.ByteBuffer>(_list66.size);
          java.nio.ByteBuffer _elem67;
          for (int _i68 = 0; _i68 < _list66.size; ++_i68)
          {
            _elem67 = iprot.readBinary();
            struct.assist.add(_elem67);
          }
        }
        struct.setAssistIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.exclude = new java.util.ArrayList<java.nio.ByteBuffer>(_list69.size);
          java.nio.ByteBuffer _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = iprot.readBinary();
            struct.exclude.add(_elem70);
          }
        }
        struct.setExcludeIsSet(true);
      }
