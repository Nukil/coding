...
public class SearchImgByAssistResponse implements org.apache.thrift.TBase<SearchImgByAssistResponse, SearchImgByAssistResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SearchImgByAssistResponse> {
  ...
  public SearchImgByAssistResponse setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SearchImgByAssistResponse(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result = new java.util.ArrayList<SearchImgResult>(_list72.size);
                SearchImgResult _elem73;
                for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                {
                  _elem73 = new SearchImgResult();
                  _elem73.read(iprot);
                  struct.result.add(_elem73);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SearchImgByAssistResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.result != null) {
        oprot.writeFieldBegin(RESULT_FIELD_DESC);
        {
          ...
          for (SearchImgResult _iter75 : struct.result)
          {
            _iter75.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResult()) {
        {
          ...
          for (SearchImgResult _iter76 : struct.result)
          {
            _iter76.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.result = new java.util.ArrayList<SearchImgResult>(_list77.size);
          SearchImgResult _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = new SearchImgResult();
            _elem78.read(iprot);
            struct.result.add(_elem78);
          }
        }
        struct.setResultIsSet(true);
      }
