...
public class Request implements org.apache.thrift.TBase<Request, Request._Fields>, java.io.Serializable, Cloneable {
	...
	private static final long serialVersionUID = 6383319560792653495L;
	
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Request");
	
	private static final org.apache.thrift.protocol.TField CONTROL_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("control_id", org.apache.thrift.protocol.TType.STRING, (short)1);
	...
	public String control_id; // required
	
	/** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		CONTROL_ID((short)1, "control_id");
	...
	static {
		...
		tmpMap.put(_Fields.CONTROL_ID, new org.apache.thrift.meta_data.FieldMetaData("control_id", org.apache.thrift.TFieldRequirementType.DEFAULT, 
	...
	public Request(Request other) {
		if (other.isSetControl_id()) {
			this.control_id = other.control_id;
		}
	}
	...
	public Request setControl_id(String control_id) {
		this.control_id = control_id;
		return this;
	}
	
	public void unsetControl_id() {
		this.control_id = null;
	}
	
	/** Returns true if field control_id is set (has been assigned a value) and false otherwise */
	public boolean isSetControl_id() {
		return this.control_id != null;
	}
	
	public void setControl_idIsSet(boolean value) {
		if (!value) {
			this.control_id = null;
		}
	}
	...
	public boolean equals(Request that) {
		...
		boolean this_present_control_id = true && this.isSetControl_id();
		boolean that_present_control_id = true && that.isSetControl_id();
		if (this_present_control_id || that_present_control_id) {
			if (!(this_present_control_id && that_present_control_id))
				return false;
			if (!this.control_id.equals(that.control_id))
				return false;
		}
	...
	public int compareTo(Request other) {
		...
		lastComparison = Boolean.valueOf(isSetControl_id()).compareTo(typedOther.isSetControl_id());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetControl_id()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.control_id, typedOther.control_id);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	private static class RequestStandardScheme extends StandardScheme<Request> {
			...
			while (true)
			{
				...
				case 1: // CONTROL_ID
					if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
						struct.control_id = iprot.readString();
						struct.setControl_idIsSet(true);
					} else { 
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot, Request struct) throws org.apache.thrift.TException {
			...
			if (struct.control_id != null) {
				oprot.writeFieldBegin(CONTROL_ID_FIELD_DESC);
				oprot.writeString(struct.control_id);
				oprot.writeFieldEnd();
			}
